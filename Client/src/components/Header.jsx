...
const Header = () => {
  ...
  return (
    ...
    <img src={assets.star_icon} className='w-2.5'/>
        ...
        <form onSubmit={onSubmitHandler} className='flex justify-between max-w-lg max-sm:scale-75 mx-auto border border-gray-300 bg-white rounded overflow-hidden gap-1'>
            <input ref={inputRef} type='text' placeholder='Search for Blogs' className='outline-none pl-4 w-full'></input>
