...
import CompComments from '../../components/Admin/CompComments'
...
return comment.isApproved===false;
  }).map((comment,index)=><CompComments key={comment._id} comment={comment} index={index+1} fetchComments={fetchComments} />)}
</tbody>
</table>
      </div>
    </div>
